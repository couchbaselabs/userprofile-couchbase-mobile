...
[source,swift]
----
include::{examplesdir}/model/UserRecord.swift[tags=userrecord]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=openOrCreateDatabaseForUser]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=dbconfig]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=dbcreate]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=registerForDatabaseChanges]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=adddbchangelistener]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=closeDatabaseForCurrentUser]
----

* Closing the database is pretty straightforward
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=dbclose]
----
...
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=deregisterForDatabaseChanges]
----

* We stop listening to database changes by passing in the `ListenerToken` associated with the listener. 
[source,swift]
----
include::{examplesdir}/model/DatabaseManager.swift[tags=removedbchangelistener]
----
...
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=userProfileDocId]
----

* In the *UserPresenter.swift* file, locate the `fetchRecordForCurrentUser()` function. 
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=fetchRecordForCurrentUser]
----
...
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=docfetch]
----
...
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=setRecordForCurrentUser]
----
...
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=docset]
----
...
[source,swift]
----
include::{examplesdir}/presenter/UserPresenter.swift[tags=docsave]
----
...
image::image_selection.gif[Image Selection]
...
image::log_off_on.gif[Log Off and Log Back On]
