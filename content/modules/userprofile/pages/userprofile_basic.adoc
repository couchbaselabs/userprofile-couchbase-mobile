...
* Use Couchbase Lite as a standalone embedded database within your mobile apps or,
* Use Couchbase Lite enabled mobile clients with a Sync Gateway to sychronize data between your mobile clients or,
* Use Couchbase Lite enabled clients with a Sync Gateway to sync data between mobile clients and the Couchbase Server, which can persist data in the cloud (public or private) 
...
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=userProfileDocId]
----

* In the *UserPresenter.swift* file, locate the `fetchRecordForCurrentUser()` function. 
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=fetchRecordForCurrentUser]
----
...
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=docfetch]
----
...
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=setRecordForCurrentUser]
----
...
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=docset]
----
...
[source,swift]
----
include::{codedir}/presenter/UserPresenter.swift[tags=docsave]
----
