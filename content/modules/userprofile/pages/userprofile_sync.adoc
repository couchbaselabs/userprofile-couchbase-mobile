...
+
image::https://raw.githubusercontent.com/couchbaselabs/userprofile-couchbase-mobile/sync/content/modules/userprofile/assets/images/syncing_from_sgw.gif[App Sync]
