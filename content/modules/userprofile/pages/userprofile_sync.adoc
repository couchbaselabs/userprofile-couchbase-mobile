...
The quick brown fox was in a rush for the arrival of the function's boss.
...
* Setup a basic Couchbase Sync Gateway configuration to sync content between multiple Couchbase Lite enabled clients. We will will cover the basics of the {sync-gateway-config-overview--xref}
