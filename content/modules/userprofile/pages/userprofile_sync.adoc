...
:standalone--xref: xref:standalone@userprofile-couchbase-mobile:userprofile:userprofile_basic.adoc[Standalone tutorial]
:query--xref: xref:query@userprofile-couchbase-mobile:userprofile:userprofile_query.adoc[Query tutorial]
:sync--xref: xref:sync@userprofile-couchbase-mobile:userprofile:userprofile_sync.adoc[Sync tutorial]
...
// Allow override from antora.yml file
ifdef::github_root_override[:git-tutorial-root: {github_root_override}]
...
:blog-doc-conflicts--url: https://blog.couchbase.com/document-conflicts-couchbase-mobile/[Document Conflicts & Resolution ^]
...
Next, we will download the Couchbase Lite {target-version} framework.
