...
// Git Content Links
:git-branch: DOC-9382/sync
// ifdef::github_branch_override[:git-branch: {github_branch_override}]
...
:git-sync--url: {git-tutorial-root}/blob/{git-branch}/content/modules/userprofile-sync/examples/
:config-filename: sync-gateway-config-userprofile-demo

:config-file-3x0-legacy--url: {git-sync--url}{sgw-config-filename-3x0}[sync-gateway-config-userprofile-demo-3-x-legacy.json]
:config-file-2x8--url: {git-sync--url}{sgw-config-filename-2x8}[sync-gateway-config-userprofile-demo-2-x.json]

Seeking {config-file-3x0-legacy--url}
