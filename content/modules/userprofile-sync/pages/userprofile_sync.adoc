...
:config-file-3x0-legacy--url: link:{attachmentsdir}/{sgw-config-filename-3x0}[sync-gateway-config-userprofile-demo-3-x-legacy.json^]

:config-file-2x8--url: link:{attachmentsdir}/{sgw-config-filename-2x8}[sync-gateway-config-userprofile-demo-2-x.json^]
...
`/path/to/cloned/repo/userprofile-couchbase-mobile/content/modules/userprofile-sync/assets/attachments` +
{empty}
