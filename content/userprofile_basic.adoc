:toc: left
:toclevels: 3
:codedir: https://github.com/couchbaselabs/userprofile-couchbase-mobile
toc::[]
:icons: font
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=userrecord]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=openOrCreateDatabaseForUser]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=dbconfig]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=dbcreate]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=registerForDatabaseChanges]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=adddbchangelistener]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=closeDatabaseForCurrentUser]
----

* Closing the database is pretty straightforward
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=dbclose]
----
...
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=deregisterForDatabaseChanges]
----

* We stop listening to database changes by passing in the `ListenerToken` associated with the listener. 
[source,swift]
----
include::{codedir}/UserRecord.swift[tags=removedbchangelistener]
----
