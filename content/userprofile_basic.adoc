...
Once the user logs in and an instance of the Couchbase Lite Database corresponding to the user is created/opened, we can perform basic Document functions on the Database
