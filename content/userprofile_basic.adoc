...
This tutorial will walk you through a sample iOS app that will demonstrate how you can get started with Couchbase Lite 2.0 in *standalone mode* as a local embedded store. Couchbase Lite in standalone mode can be a replacement to SQLite or Core Data.
