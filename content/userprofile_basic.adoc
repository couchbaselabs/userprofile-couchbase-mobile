...
This tutorial will walk you through a very basic example of how you can get use  *Couchbase Lite 2.0 in standalone mode* within your iOS App. Couchbase Lite will serve as a local, embedded data store within your iOS App and can be a replacement for SQLite or Core Data.
